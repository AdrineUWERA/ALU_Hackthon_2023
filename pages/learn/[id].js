                ...
                {course.topics.map((topic, index) => (
                  <li key={course.id}>
                    <button
                      ...
                      data-collapse-target="#dropdown-example"
              ...
              <div class="container mx-auto px-4">
                <div class="flex justify-end">
                  <Link
                    href={{
                      pathname: "/quiz/[title]",
                      query: { title: `${contentTitle.split(" ").join("-")}`},
                    }}
                    key={contentTitle}
                  >
                    <button class="inline-flex gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 mr-4">
                      Practice Quiz
                    </button>
                  </Link>
                      ...
                      >
                        <div class="py-1" role="none">
                          <a
                            ...
                            tabindex="-1"
                            id="menu-item-0"
                            onClick={() => regenerateFunction("beginner")}
                          >
                            Beginner friendly
                          </a>
                          <a
                            ...
                            tabindex="-1"
                            id="menu-item-1"
                            onClick={() => regenerateFunction("intermediate")}
                          >
                            Intermediate level
                          </a>
                          <a
                            ...
                            tabindex="-1"
                            id="menu-item-2"
                            onClick={() => regenerateFunction("advanced")}
                          >
                            Advanced level
                          </a>
                          <a
                            ...
                            tabindex="-1"
                            id="menu-item-2"
                            onClick={() => regenerateFunction("summarize")}
                          >
                            Summarize Content
                          </a>
                        </div>
